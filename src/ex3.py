...
# Excelへレポートを出力する
def export_to_excel(df, status_summary, priority_summary, assignee_summary, unresolved_df, output_path):
...
def main():
    ...
    export_to_excel(df, status_summary, priority_summary, assignee_summary, unresolved_df, output_path)
